...
def _should_skip(full_ticket: ComputeAllocationRequestTicket, reply_mode: ReplyMode) -> bool:
...
def _process_ticket(
    ...
    """
    full_ticket: ComputeAllocationRequestTicket = service_now.get_full_ticket(ticket)
